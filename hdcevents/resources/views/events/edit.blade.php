    ...
    <div id="event-create-container" class="col-md-6 offset-md-3">
        ...
        <form action="/events/update/{{ $event->id }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="title" name="title" placeholder="Nome do evento" value="{{ $event->title }}" autofocus>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select name="private" id="private" class="form-control form-select">
